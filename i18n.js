...
window.I18N = (function () {
  ...
  const DICT = {
    ...
    index: {
      ...
      projCtaTitle: { en: 'Next Round Projection: who to pick for Round of 32', id: 'Proyeksi Ronde Depan: pilihan pemain untuk Babak 32 Besar', ar: 'توقع الجولة القادمة: من تختار لدور الـ32', ms: 'Unjuran Pusingan Seterusnya: pilihan pemain untuk Pusingan 32' },
      projCtaSub: { en: 'Best 15 squad forecast with budget, qualifier status, and rotation risk — updated live.', id: 'Proyeksi Best 15 lengkap dengan budget, status lolos, dan risiko rotasi — selalu update.', ar: 'توقع أفضل 15 لاعباً مع الميزانية وحالة التأهل وخطر التدوير — يُحدَّث مباشرة.', ms: 'Unjuran 15 Terbaik lengkap dengan bajet, status layak, dan risiko putaran — kemas kini secara live.' },
