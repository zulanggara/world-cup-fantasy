...
window.I18N = (function () {
  ...
  const DICT = {
    nav: {
      ...
      marketOdds: { en: 'Market Odds', id: 'Odds Pasar', ar: 'احتمالات السوق', ms: 'Odds Pasaran' },
    ...
    index: {
      ...
      marketPanelTitle: { en: 'Win World Cup — Market Odds (Top 8)', id: 'Win World Cup — Odds Pasar (Top 8)', ar: 'الفوز بكأس العالم — احتمالات السوق (أفضل 8)', ms: 'Menang Piala Dunia — Odds Pasaran (Top 8)' },
      marketPanelLink: { en: 'Full breakdown by stage →', id: 'Rincian lengkap per babak →', ar: 'التفاصيل الكاملة حسب المرحلة ←', ms: 'Pecahan penuh mengikut peringkat →' },
      marketPanelSub: { en: 'Sourced from Polymarket prediction markets, refreshed with every data sync.', id: 'Bersumber dari pasar prediksi Polymarket, diperbarui setiap sinkronisasi data.', ar: 'مصدرها أسواق التوقعات في Polymarket، تُحدَّث مع كل مزامنة بيانات.', ms: 'Bersumber daripada pasaran ramalan Polymarket, dikemas kini setiap penyegerakan data.' },
      projCtaTitle: { en: 'Next Round Projection: who to pick for the Final', id: 'Proyeksi Ronde Depan: pilihan pemain untuk Final', ar: 'توقع الجولة القادمة: من تختار للنهائي', ms: 'Unjuran Pusingan Seterusnya: pilihan pemain untuk Perlawanan Akhir' },
      projCtaSub: { en: 'Best 15 squad forecast for the Final — 4 SF teams, max 8 players per nation, updated live.', id: 'Proyeksi Best 15 untuk Final — 4 tim SF, maks 8 pemain per negara, diperbarui langsung.', ar: 'توقع أفضل 15 لاعباً للنهائي — 4 فرق نصف النهائي، حد أقصى 8 لاعبين لكل دولة.', ms: 'Unjuran 15 Terbaik untuk Perlawanan Akhir — 4 pasukan SF, maks 8 pemain setiap negara.' },
      projCtaBtn: { en: 'Build squad →', id: 'Susun skuad →', ar: 'بناء التشكيلة ←', ms: 'Bina skuad →' },
      recapTitle: { en: 'Best 15 Recap — Projection vs Actual', id: 'Rekap Best 15 — Proyeksi vs Aktual', ar: 'ملخص أفضل 15 — التوقع مقابل الفعلي', ms: 'Rekap 15 Terbaik — Unjuran lawan Sebenar' },
      recapSub: { en: 'For each round already played, the Best 15 squad the index would have picked (same rules: 2-5-5-3, max 3/country) — projected points vs what those 15 players actually scored.', id: 'Untuk setiap ronde yang sudah dimainkan, skuad Best 15 yang akan dipilih index (aturan sama: 2-5-5-3, maks 3/negara) — proyeksi poin vs poin aktual yang didapat 15 pemain tersebut.', ar: 'لكل جولة لُعبت فعلاً، التشكيلة المثلى من 15 لاعباً التي سيختارها المؤشر (نفس القواعد: 2-5-5-3، بحد أقصى 3 لكل دولة) — النقاط المتوقعة مقابل ما سجله هؤلاء اللاعبون فعلياً.', ms: 'Bagi setiap pusingan yang sudah dimainkan, skuad 15 Terbaik yang akan dipilih index (peraturan sama: 2-5-5-3, maks 3/negara) — mata unjuran berbanding mata sebenar yang diperoleh 15 pemain tersebut.' },
      recapR32Label: { en: 'R32', id: 'R32', ar: 'دور الـ32', ms: 'R32' },
      recapR16Label: { en: 'R16', id: 'R16', ar: 'دور الـ16', ms: 'R16' },
      recapQFLabel: { en: 'QF', id: 'QF', ar: 'ر.النهائي', ms: 'QF' },
    ...
    nextround: {
      ...
      legendConfirmed: { en: 'confirmed qualifier', id: 'pasti lolos', ar: 'تأهل مؤكد', ms: 'pasti layak' },
      legendProjected: { en: 'projected qualifier', id: 'diproyeksikan lolos', ar: 'تأهل متوقع', ms: 'diunjurkan layak' },
      legendRotation: { en: 'rotation risk (low minutes)', id: 'risiko rotasi (minim menit main)', ar: 'خطر التدوير (دقائق قليلة)', ms: 'risiko putaran (minit rendah)' },
      legendScore: { en: 'index score (0-100)', id: 'skor indeks (0-100)', ar: 'مؤشر النتيجة (0-100)', ms: 'skor indeks (0-100)' },
      legendWin: { en: 'opponent + win chance', id: 'lawan + win chance', ar: 'الخصم + فرصة الفوز', ms: 'lawan + peluang menang' },
      ...
      r32Option: { en: 'Round of 32', id: 'Babak 32 Besar', ar: 'دور الـ32', ms: 'Pusingan 32' },
      r32Disclaimer: {
        en: '<b>Round of 32 mode:</b> the group stage is now complete, so the 32 qualifiers and the full R32 bracket are FIFA\'s real, fixed fixtures (from <code>data/matches.json</code>) — no longer a standings-based projection. <b>✓ confirmed qualifier</b> reflects this. Squad selection is <b>unlimited transfers</b> for this round — pick freely from all 32 teams. Since transfers are limited again from R16 onward, the index score also gives a small bonus to players whose team has higher odds (Polymarket) of also making R16, so this squad needs fewer changes once that round opens. Opponent strength blends real-match goal data, <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a> win expectancy, and Polymarket\'s "make R16" odds for the opponent. Budget gets a flat <b>+$5M</b> bonus from this round onward (not an extra +5 every round). Max 3 players per nation still applies.',
        id: '<b>Mode Babak 32 Besar:</b> fase grup sudah selesai, jadi 32 tim yang lolos dan bracket R32 lengkap adalah jadwal resmi FIFA (dari <code>data/matches.json</code>) — bukan lagi proyeksi dari klasemen. <b>✓ pasti lolos</b> mencerminkan hal ini. Pemilihan skuad untuk ronde ini <b>unlimited transfer</b> — bebas pilih dari 32 tim mana saja. Karena transfer kembali terbatas mulai R16, skor indeks juga memberi bonus kecil ke pemain dari tim yang odds-nya (Polymarket) lebih tinggi untuk ikut lolos ke R16, supaya skuad ini tidak perlu banyak berubah saat ronde itu dibuka. Kekuatan lawan dihitung dari gabungan data gol pertandingan nyata, win expectancy <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "lolos R16" Polymarket untuk lawan. Budget mendapat bonus flat <b>+$5M</b> mulai ronde ini (bukan tambahan +5 setiap ronde). Tetap berlaku maksimal 3 pemain per negara.',
        ar: '<b>وضع دور الـ32:</b> انتهت مرحلة المجموعات، فأصبحت الفرق المتأهلة الـ32 وجدول دور الـ32 الكامل هي مباريات فيفا الرسمية الثابتة (من <code>data/matches.json</code>) — وليست توقعاً من الترتيب بعد الآن. <b>✓ تأهل مؤكد</b> يعكس ذلك. اختيار التشكيلة لهذه الجولة <b>تبديلات غير محدودة</b> — اختر بحرية من جميع الفرق الـ32. ولأن التبديلات تصبح محدودة مجدداً من دور الـ16، يضيف مؤشر النتيجة أيضاً ميزة صغيرة للاعبين من فرق لديها احتمالات أعلى (Polymarket) لبلوغ دور الـ16 أيضاً، حتى تحتاج هذه التشكيلة لتغييرات أقل عند بدء تلك الجولة. تُحسب قوة الخصم من دمج بيانات الأهداف الحقيقية، احتمالية الفوز من <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>، واحتمالات "بلوغ دور الـ16" من Polymarket للخصم. تحصل الميزانية على زيادة ثابتة <b>+5 مليون دولار</b> من هذه الجولة فصاعداً (ليست زيادة إضافية +5 كل جولة). يبقى الحد الأقصى 3 لاعبين لكل دولة سارياً.',
        ms: '<b>Mod Pusingan 32:</b> peringkat kumpulan kini sudah tamat, jadi 32 pasukan yang layak dan bracket R32 penuh adalah perlawanan rasmi FIFA yang tetap (daripada <code>data/matches.json</code>) — bukan lagi unjuran berdasarkan kedudukan. <b>✓ pasti layak</b> mencerminkan ini. Pemilihan skuad untuk pusingan ini <b>pertukaran tanpa had</b> — pilih bebas daripada semua 32 pasukan. Oleh kerana pertukaran terhad semula bermula R16, skor indeks juga memberi bonus kecil kepada pemain daripada pasukan yang odds-nya (Polymarket) lebih tinggi untuk turut layak ke R16, supaya skuad ini perlu lebih sedikit perubahan apabila pusingan itu dibuka. Kekuatan lawan digabungkan daripada data gol perlawanan sebenar, jangkaan menang <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "layak R16" Polymarket untuk lawan. Bajet mendapat bonus flat <b>+$5M</b> mulai pusingan ini (bukan tambahan +5 setiap pusingan). Maksimum 3 pemain setiap negara masih dikuatkuasakan.',
      },
      r16Option: { en: 'Round of 16', id: 'Babak 16 Besar', ar: 'دور الـ16', ms: 'Pusingan 16' },
      qfOption: { en: 'Quarter Finals', id: 'Perempat Final', ar: 'ربع النهائي', ms: 'Suku Akhir' },
      sfOption: { en: 'Semi Finals', id: 'Semifinal', ar: 'نصف النهائي', ms: 'Separuh Akhir' },
      fOption: { en: 'Final', id: 'Final', ar: 'النهائي', ms: 'Perlawanan Akhir' },
      r16Disclaimer: {
        en: '<b>Round of 16 mode:</b> only teams that have already won their Round of 32 match are included — this list grows automatically as more R32 matches finish, and locks in once the whole R32 round is complete. Squad selection is <b>unlimited transfers</b> for this round. Opponent strength blends real-match goal data, <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a> win expectancy, and Polymarket\'s "make QF" odds for the opponent. Budget keeps the same flat <b>+$5M</b> bonus as R32 (not an extra +5). <b>Max 4 players per nation</b> for this round (up from 3 in earlier rounds).',
        id: '<b>Mode Babak 16 Besar:</b> hanya tim yang sudah memenangkan pertandingan Babak 32 Besar-nya yang dimasukkan — daftar ini bertambah otomatis seiring makin banyak pertandingan R32 yang selesai, dan akan final begitu seluruh babak R32 tuntas. Pemilihan skuad untuk ronde ini tetap <b>unlimited transfer</b>. Kekuatan lawan dihitung dari gabungan data gol pertandingan nyata, win expectancy <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "lolos QF" Polymarket untuk lawan. Budget tetap mendapat bonus flat <b>+$5M</b> sama seperti R32 (bukan tambahan +5 lagi). <b>Maksimal 4 pemain per negara</b> untuk ronde ini (naik dari 3 di ronde-ronde sebelumnya).',
        ar: '<b>وضع دور الـ16:</b> لا تُدرج إلا الفرق التي فازت بالفعل في مباراتها بدور الـ32 — تكبر هذه القائمة تلقائياً مع انتهاء المزيد من مباريات دور الـ32، وتصبح نهائية عند اكتمال الدور بالكامل. اختيار التشكيلة لهذه الجولة <b>تبديلات غير محدودة</b>. تُحسب قوة الخصم من دمج بيانات الأهداف الحقيقية، احتمالية الفوز من <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>، واحتمالات "بلوغ ربع النهائي" من Polymarket للخصم. تحصل الميزانية على نفس زيادة <b>+5 مليون دولار</b> كما في دور الـ32 (بدون زيادة إضافية). <b>الحد الأقصى 4 لاعبين لكل دولة</b> لهذه الجولة (بعد أن كان 3 في الجولات السابقة).',
        ms: '<b>Mod Pusingan 16:</b> hanya pasukan yang sudah memenangi perlawanan Pusingan 32 mereka dimasukkan — senarai ini bertambah secara automatik apabila lebih banyak perlawanan R32 tamat, dan menjadi muktamad sebaik sahaja seluruh pusingan R32 selesai. Pemilihan skuad untuk pusingan ini <b>pertukaran tanpa had</b>. Kekuatan lawan digabungkan daripada data gol perlawanan sebenar, jangkaan menang <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "layak QF" Polymarket untuk lawan. Bajet kekal dengan bonus flat <b>+$5M</b> sama seperti R32 (bukan tambahan +5). <b>Maksimum 4 pemain setiap negara</b> untuk pusingan ini (naik daripada 3 pada pusingan sebelumnya).',
      },
      qfDisclaimer: {
        en: '<b>Quarter Finals mode:</b> only teams that have already won their Round of 16 match are included — the list grows automatically as R16 results come in. Opponent strength blends real-match goal data, <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a> win expectancy, and Polymarket\'s "make SF" odds for the opponent. Budget keeps the same flat <b>+$5M</b> bonus. <b>Max 5 players per nation</b> for this round (up from 4 in R16).',
        id: '<b>Mode Perempat Final:</b> hanya tim yang sudah memenangkan pertandingan Babak 16 Besar-nya yang dimasukkan — daftar ini bertambah otomatis seiring hasil R16 masuk. Kekuatan lawan dihitung dari gabungan data gol pertandingan nyata, win expectancy <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "lolos SF" Polymarket untuk lawan. Budget tetap mendapat bonus flat <b>+$5M</b> sama seperti ronde sebelumnya. <b>Maksimal 5 pemain per negara</b> untuk ronde ini (naik dari 4 di R16).',
        ar: '<b>وضع ربع النهائي:</b> تُدرج فقط الفرق التي فازت بالفعل في مباراتها بدور الـ16 — تكبر القائمة تلقائياً مع ورود نتائج دور الـ16. تُحسب قوة الخصم من دمج بيانات الأهداف الحقيقية، احتمالية الفوز من <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>، واحتمالات "بلوغ نصف النهائي" من Polymarket للخصم. تحتفظ الميزانية بنفس الزيادة الثابتة <b>+5 مليون دولار</b>. <b>الحد الأقصى 5 لاعبين لكل دولة</b> لهذه الجولة (بعد أن كان 4 في دور الـ16).',
        ms: '<b>Mod Suku Akhir:</b> hanya pasukan yang sudah memenangi perlawanan Pusingan 16 mereka dimasukkan — senarai ini bertambah secara automatik apabila keputusan R16 masuk. Kekuatan lawan digabungkan daripada data gol perlawanan sebenar, jangkaan menang <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "layak SF" Polymarket untuk lawan. Bajet kekal dengan bonus flat <b>+$5M</b> sama seperti pusingan sebelumnya. <b>Maksimum 5 pemain setiap negara</b> untuk pusingan ini (naik daripada 4 pada R16).',
      },
      sfDisclaimer: {
        en: '<b>Semi Finals mode:</b> only teams that have already won their Quarter Final match are included — the list resolves automatically as QF results come in. Opponent strength blends real-match goal data, <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a> win expectancy, and Polymarket\'s "make Final" odds for the opponent. Budget keeps the same flat <b>+$5M</b> bonus. <b>Max 6 players per nation</b> for this round (up from 5 in QF).',
        id: '<b>Mode Semifinal:</b> hanya tim yang sudah memenangkan pertandingan Perempat Final-nya yang dimasukkan — daftar ini terisi otomatis seiring hasil QF masuk. Kekuatan lawan dihitung dari gabungan data gol pertandingan nyata, win expectancy <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "lolos Final" Polymarket untuk lawan. Budget tetap mendapat bonus flat <b>+$5M</b>. <b>Maksimal 6 pemain per negara</b> untuk ronde ini (naik dari 5 di QF).',
        ar: '<b>وضع نصف النهائي:</b> تُدرج فقط الفرق التي فازت بمباراتها في ربع النهائي — تكتمل القائمة تلقائياً مع ورود نتائج ربع النهائي. تُحسب قوة الخصم من بيانات الأهداف الحقيقية، احتمالية الفوز من <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>، واحتمالات "بلوغ النهائي" من Polymarket. تحتفظ الميزانية بنفس الزيادة <b>+5 مليون دولار</b>. <b>الحد الأقصى 6 لاعبين لكل دولة</b>.',
        ms: '<b>Mod Separuh Akhir:</b> hanya pasukan yang telah memenangi perlawanan Suku Akhir mereka dimasukkan — senarai ini lengkap secara automatik apabila keputusan QF masuk. Kekuatan lawan digabungkan daripada data gol, jangkaan menang <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "layak Final" Polymarket. Bajet kekal <b>+$5M</b>. <b>Maksimum 6 pemain setiap negara</b>.',
      },
      fDisclaimer: {
        en: '<b>Final mode:</b> pool = all 4 SF teams (before SF results, opponents are TBD; once SF finishes the 2 finalists get proper opponent data). Primary signal: Polymarket "win WC" odds. Budget keeps the same flat <b>+$5M</b> bonus. <b>Max 8 players per nation</b> for this round.',
        id: '<b>Mode Final:</b> pool = 4 tim SF (sebelum SF selesai, lawan masih TBD; begitu SF tuntas, 2 finalis mendapat data lawan yang tepat). Sinyal utama: odds "menang WC" dari Polymarket. Budget tetap mendapat bonus flat <b>+$5M</b>. <b>Maksimal 8 pemain per negara</b> untuk ronde ini.',
        ar: '<b>وضع النهائي:</b> المجموعة = 4 فرق من نصف النهائي (قبل نتائج نصف النهائي، الخصوم غير محددين؛ بعد نصف النهائي يحصل الفريقان النهائيان على بيانات الخصم). الإشارة الرئيسية: احتمالات "الفوز بالكأس" من Polymarket. الميزانية مع مكافأة <b>+5 مليون دولار</b>. <b>الحد الأقصى 8 لاعبين لكل دولة</b>.',
        ms: '<b>Mod Perlawanan Akhir:</b> kolam = 4 pasukan SF (sebelum keputusan SF, lawan masih TBD; setelah SF selesai, 2 finalis mendapat data lawan yang betul). Isyarat utama: odds "menang WC" dari Polymarket. Bajet kekal <b>+$5M</b>. <b>Maksimum 8 pemain setiap negara</b>.',
      },
      opponentTBD: { en: 'R32 opponent not determined yet', id: 'lawan R32 belum ditentukan', ar: 'خصم دور الـ32 غير محدد بعد', ms: 'lawan Pusingan 32 belum ditentukan' },
      opponentTBDR16: { en: 'R16 opponent not determined yet', id: 'lawan R16 belum ditentukan', ar: 'خصم دور الـ16 غير محدد بعد', ms: 'lawan Pusingan 16 belum ditentukan' },
      opponentProjected: { en: 'projected', id: 'proyeksi', ar: 'متوقع', ms: 'unjuran' },
      qualifiedConfirmed: { en: 'confirmed qualifier', id: 'pasti lolos', ar: 'تأهل مؤكد', ms: 'pasti layak' },
      qualifiedProjected: { en: 'projected qualifier', id: 'diproyeksikan lolos', ar: 'تأهل متوقع', ms: 'diunjurkan layak' },
      actualSuffix: { en: 'actual', id: 'aktual', ar: 'فعلي', ms: 'sebenar' },
      actualPointsTip: { en: 'Actual points scored this round (official FIFA result)', id: 'Poin aktual yang didapat di ronde ini (hasil resmi FIFA)', ar: 'النقاط الفعلية المسجلة هذه الجولة (نتيجة فيفا الرسمية)', ms: 'Mata sebenar diperoleh pusingan ini (keputusan rasmi FIFA)' },
      actualTotalTip: { en: '{n}/15 starters have played this round so far', id: '{n}/15 starter sudah main di ronde ini sejauh ini', ar: '{n}/15 لاعباً أساسياً لعبوا هذه الجولة حتى الآن', ms: '{n}/15 starter sudah bermain pusingan ini sejauh ini' },
    },
    research: {
    ...
    marketOdds: {
      kicker: { en: 'Prediction Market', id: 'Prediction Market', ar: 'سوق التوقعات', ms: 'Pasaran Ramalan' },
      heroTitle: { en: 'Market Odds', id: 'Odds Pasar', ar: 'احتمالات السوق', ms: 'Odds Pasaran' },
      heroSubtitle: { en: "Each team's win probability for every World Cup 2026 stage, from Polymarket prediction markets — refreshed automatically with every data sync.", id: 'Peluang menang tiap tim di setiap babak World Cup 2026, dari pasar prediksi Polymarket — diperbarui otomatis setiap kali data disinkronkan.', ar: 'احتمالية فوز كل فريق في كل مرحلة من كأس العالم 2026، من أسواق التوقعات في Polymarket — تُحدَّث تلقائياً مع كل مزامنة بيانات.', ms: 'Kebarangkalian menang setiap pasukan bagi setiap peringkat World Cup 2026, daripada pasaran ramalan Polymarket — dikemas kini secara automatik setiap kali data disegerakkan.' },
      disclaimer: {
        en: 'Data from <b>Polymarket</b> (<a href="https://polymarket.com" target="_blank" rel="noopener noreferrer">polymarket.com</a>), a real-money prediction market — not an official FIFA forecast or a guarantee of results. Teams already mathematically eliminated/qualified show 0%/100%. Used as an extra signal (alongside eloratings.net Elo and real goal data) for next-round Best 15 projections.',
        id: 'Data dari <b>Polymarket</b> (<a href="https://polymarket.com" target="_blank" rel="noopener noreferrer">polymarket.com</a>), pasar prediksi berbasis uang sungguhan — bukan odds resmi FIFA maupun garansi hasil. Tim yang sudah pasti tersingkir/lolos secara matematis ditampilkan 0%/100%. Digunakan sebagai sinyal tambahan (selain Elo eloratings.net dan data gol nyata) untuk proyeksi Best 15 ronde berikutnya.',
        ar: 'البيانات من <b>Polymarket</b> (<a href="https://polymarket.com" target="_blank" rel="noopener noreferrer">polymarket.com</a>)، سوق توقعات بأموال حقيقية — ليست توقعات رسمية من فيفا ولا ضماناً للنتائج. الفرق المؤكد تأهلها أو خروجها رياضياً تُعرض 0%/100%. تُستخدم كإشارة إضافية (إلى جانب Elo من eloratings.net وبيانات الأهداف الحقيقية) لتوقعات أفضل 15 للجولة القادمة.',
        ms: 'Data daripada <b>Polymarket</b> (<a href="https://polymarket.com" target="_blank" rel="noopener noreferrer">polymarket.com</a>), pasaran ramalan berasaskan wang sebenar — bukan ramalan rasmi FIFA mahupun jaminan keputusan. Pasukan yang sudah pasti tersingkir/layak secara matematik dipaparkan 0%/100%. Digunakan sebagai isyarat tambahan (selain Elo eloratings.net dan data gol sebenar) untuk unjuran 15 Terbaik pusingan seterusnya.',
      },
      chartTitle: { en: 'Win World Cup — Odds History (Top 8)', id: 'Win World Cup — Riwayat Odds (Top 8)', ar: 'الفوز بكأس العالم — تاريخ الاحتمالات (أفضل 8)', ms: 'Menang Piala Dunia — Sejarah Odds (Top 8)' },
      chartSub: { en: "Polymarket's daily \"Win World Cup\" market price for the current top 8 teams.", id: 'Harga harian pasar "Win World Cup" Polymarket untuk 8 tim teratas saat ini.', ar: 'سعر سوق "الفوز بكأس العالم" اليومي في Polymarket لأفضل 8 فرق حالياً.', ms: 'Harga harian pasaran "Win World Cup" Polymarket untuk 8 pasukan teratas semasa.' },
      tableTitle: { en: 'All Teams', id: 'Semua Tim', ar: 'جميع الفرق', ms: 'Semua Pasukan' },
      tableSub: { en: 'Click a column header to sort. Click a team name for details.', id: 'Klik header kolom untuk urutkan. Klik nama tim untuk detail.', ar: 'اضغط على عنوان العمود للترتيب. اضغط على اسم الفريق للتفاصيل.', ms: 'Klik tajuk lajur untuk susun. Klik nama pasukan untuk butiran.' },
      colWinGroup: { en: 'Win Group', id: 'Juara Grup', ar: 'فوز المجموعة', ms: 'Menang Kumpulan' },
      colMakeR32: { en: 'Make R32', id: 'Lolos R32', ar: 'بلوغ دور 32', ms: 'Layak R32' },
      colMakeR16: { en: 'Make R16', id: 'Lolos R16', ar: 'بلوغ دور 16', ms: 'Layak R16' },
      colMakeQF: { en: 'Make QF', id: 'Lolos QF', ar: 'بلوغ ربع النهائي', ms: 'Layak QF' },
      colMakeSF: { en: 'Make SF', id: 'Lolos SF', ar: 'بلوغ نصف النهائي', ms: 'Layak SF' },
      colMakeFinal: { en: 'Make Final', id: 'Lolos Final', ar: 'بلوغ النهائي', ms: 'Layak Final' },
      colWinWC: { en: 'Win WC', id: 'Juara WC', ar: 'الفوز بالكأس', ms: 'Menang WC' },
      lastFetched: { en: 'Last fetched:', id: 'Terakhir diambil:', ar: 'آخر جلب للبيانات:', ms: 'Terakhir diambil:' },
    },
    groups: {
      ...
      heroSubtitle: { en: '12 group standings, the real Round-of-32 knockout bracket, and upcoming fixtures — all times in WIB (Indonesia time). Click a team code for match results & roster.', id: 'Klasemen 12 grup, bagan babak 32 besar (data real), dan jadwal mendatang — semua jam dalam WIB. Klik kode tim untuk lihat hasil pertandingan & roster.', ar: 'ترتيب 12 مجموعة، شجرة دور الـ32 الفعلية، والمباريات القادمة — جميع الأوقات بتوقيت WIB (توقيت إندونيسيا). اضغط على رمز الفريق لعرض نتائج المباريات والتشكيلة.', ms: 'Kedudukan 12 kumpulan, bagan sebenar Pusingan 32, dan perlawanan akan datang — semua masa dalam WIB (waktu Indonesia). Klik kod pasukan untuk lihat keputusan perlawanan & senarai pemain.' },
      ...
      tabBracket: { en: 'Knockout Bracket', id: 'Bagan Babak Gugur', ar: 'شجرة دور خروج المغلوب', ms: 'Bracket Pusingan Kalah Mati' },
      ...
      bracketTitle: { en: 'Knockout Bracket', id: 'Bagan Babak Gugur', ar: 'شجرة دور خروج المغلوب', ms: 'Bracket Pusingan Kalah Mati' },
      legendConfirmed: { en: 'Confirmed team (official FIFA fixture / final standings)', id: 'Tim pasti (fixture resmi FIFA / klasemen final)', ar: 'فريق مؤكد (مباراة فيفا الرسمية / ترتيب نهائي)', ms: 'Pasukan pasti (perlawanan rasmi FIFA / kedudukan akhir)' },
      legendLive: { en: 'Projected from current standings (group stage still in progress, may change)', id: 'Diproyeksikan dari klasemen saat ini (fase grup belum selesai, bisa berubah)', ar: 'متوقع من الترتيب الحالي (دور المجموعات لم ينته، قد يتغير)', ms: 'Diunjurkan daripada kedudukan semasa (peringkat kumpulan belum tamat, boleh berubah)' },
      h2hSummary: { en: 'All-time head-to-head', id: 'Rekor head-to-head sepanjang masa', ar: 'مواجهات سابقة عبر التاريخ', ms: 'Rekod ke-kepala sepanjang zaman' },
      h2hVs: { en: 'vs', id: 'vs', ar: 'مقابل', ms: 'lwn' },
      h2hMatches: { en: 'matches', id: 'pertandingan', ar: 'مباريات', ms: 'perlawanan' },
      ...
      matchPenalties: { en: 'PEN', id: 'PEN', ar: 'ركلات ترجيح', ms: 'PEN' },
      ...
      disclaimer: {
        en: 'Group standings & schedule from <b>official FIFA data</b> (<code>play.fifa.com/json/fantasy/rounds.json</code>). Ranking <b>does not yet account for head-to-head</b> among teams tied on points — only Points → Goal Difference → Goals For. The knockout bracket shows FIFA\'s <b>real, confirmed fixtures</b> for every slot already decided — only a still-undecided slot (group stage not finished) falls back to a projection from current standings, and updates automatically once that slot is confirmed.',
        id: 'Klasemen & jadwal grup dari <b>data resmi FIFA</b> (<code>play.fifa.com/json/fantasy/rounds.json</code>). Urutan <b>belum memperhitungkan head-to-head</b> antar tim dengan poin sama — hanya Poin → Selisih Gol → Gol Memasukkan. Bagan babak gugur menampilkan <b>fixture asli & resmi FIFA</b> untuk setiap slot yang sudah ditentukan — hanya slot yang belum ditentukan (fase grup belum selesai) yang memakai proyeksi dari klasemen saat ini, dan otomatis ter-update begitu slot tersebut resmi.',
        ar: 'ترتيب وجدول المجموعات من <b>بيانات فيفا الرسمية</b> (<code>play.fifa.com/json/fantasy/rounds.json</code>). الترتيب <b>لا يأخذ بعين الاعتبار حتى الآن المواجهة المباشرة</b> بين الفرق المتساوية بالنقاط — فقط النقاط ← فرق الأهداف ← الأهداف المسجلة. تعرض شجرة دور خروج المغلوب <b>مباريات فيفا الرسمية والمؤكدة</b> لكل مقعد تم تحديده — فقط المقعد غير المحدد بعد (دور المجموعات لم ينته) يستخدم توقعاً من الترتيب الحالي، ويُحدَّث تلقائياً بعد تأكيده.',
        ms: 'Kedudukan & jadual kumpulan daripada <b>data rasmi FIFA</b> (<code>play.fifa.com/json/fantasy/rounds.json</code>). Susunan <b>belum mengambil kira pertembungan langsung</b> antara pasukan yang sama mata — hanya Mata → Perbezaan Gol → Gol Dijaringkan. Bracket pusingan kalah mati memaparkan <b>perlawanan sebenar & rasmi FIFA</b> untuk setiap slot yang sudah ditentukan — hanya slot yang belum ditentukan (peringkat kumpulan belum tamat) menggunakan unjuran daripada kedudukan semasa, dan dikemas kini secara automatik sebaik slot itu disahkan.',
      },
    },
    mysquad: {
