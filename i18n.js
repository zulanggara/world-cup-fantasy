...
window.I18N = (function () {
  ...
  const DICT = {
    ...
    nextround: {
      ...
      r32Disclaimer: {
        en: '<b>Round of 32 mode:</b> only players from teams with a currently resolved R32 slot are included — projected from live group standings (same logic as the Standings & Fixtures page\'s "R32 Projection" tab), not all 48 teams. <b>✓ confirmed qualifier</b> means the team\'s spot is already mathematically locked; <b>~ projected qualifier</b> means it\'s based on the current group table and could still change — the percentage next to it is Polymarket\'s live "make R32" market odds (see <a href="market-odds.html">Market Odds</a>). Opponent strength blends real-match goal data, <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a> win expectancy, and Polymarket\'s "make R16" odds for the opponent. Budget gets a flat <b>+$5M</b> bonus from this round onward (not an extra +5 every round). Max 3 players per nation still applies.',
        id: '<b>Mode Babak 32 Besar:</b> hanya pemain dari tim yang slot R32-nya sudah terisi (resmi atau diproyeksikan) yang ditampilkan — diproyeksikan dari klasemen grup saat ini (logika sama dengan tab "Proyeksi 32 Besar" di halaman Klasemen & Jadwal), bukan semua 48 tim. <b>✓ pasti lolos</b> berarti slotnya sudah pasti secara matematis; <b>~ diproyeksikan lolos</b> berarti berdasarkan klasemen saat ini dan masih bisa berubah — persentase di sebelahnya adalah odds pasar "lolos R32" Polymarket secara live (lihat <a href="market-odds.html">Odds Pasar</a>). Kekuatan lawan dihitung dari gabungan data gol pertandingan nyata, win expectancy <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "lolos R16" Polymarket untuk lawan. Budget mendapat bonus flat <b>+$5M</b> mulai ronde ini (bukan tambahan +5 setiap ronde). Tetap berlaku maksimal 3 pemain per negara.',
        ar: '<b>وضع دور الـ32:</b> يُعرض فقط لاعبو الفرق التي لها مكان محدد حالياً في دور الـ32 — متوقع من ترتيب المجموعات الحالي (نفس منطق تبويب "توقع دور الـ32" في صفحة الترتيب والمباريات)، وليس كل 48 فريقاً. <b>✓ تأهل مؤكد</b> يعني أن مكان الفريق مضمون رياضياً؛ <b>~ تأهل متوقع</b> يعني أنه مبني على جدول المجموعات الحالي وقد يتغير — النسبة المئوية بجانبها هي احتمالات سوق "بلوغ دور الـ32" المباشرة من Polymarket (انظر <a href="market-odds.html">احتمالات السوق</a>). تُحسب قوة الخصم من دمج بيانات الأهداف الحقيقية، احتمالية الفوز من <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>، واحتمالات "بلوغ دور الـ16" من Polymarket للخصم. تحصل الميزانية على زيادة ثابتة <b>+5 مليون دولار</b> من هذه الجولة فصاعداً (ليست زيادة إضافية +5 كل جولة). يبقى الحد الأقصى 3 لاعبين لكل دولة سارياً.',
        ms: '<b>Mod Pusingan 32:</b> hanya pemain daripada pasukan yang slot R32-nya sudah terisi (rasmi atau diunjurkan) dipaparkan — diunjurkan daripada kedudukan kumpulan semasa (logik sama dengan tab "Unjuran Pusingan 32" di halaman Kedudukan & Perlawanan), bukan semua 48 pasukan. <b>✓ pasti layak</b> bermaksud tempat pasukan sudah pasti secara matematik; <b>~ diunjurkan layak</b> bermaksud berdasarkan jadual kumpulan semasa dan masih boleh berubah — peratusan di sebelahnya adalah odds pasaran "layak R32" Polymarket secara live (lihat <a href="market-odds.html">Odds Pasaran</a>). Kekuatan lawan digabungkan daripada data gol perlawanan sebenar, jangkaan menang <a href="https://www.eloratings.net" target="_blank" rel="noopener noreferrer">eloratings.net</a>, dan odds "layak R16" Polymarket untuk lawan. Bajet mendapat bonus flat <b>+$5M</b> mulai pusingan ini (bukan tambahan +5 setiap pusingan). Maksimum 3 pemain setiap negara masih dikuatkuasakan.',
      },
