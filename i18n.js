...
window.I18N = (function () {
  ...
  const DICT = {
    ...
    groups: {
      ...
      thirdSlotsTitle: { en: 'R32 Slot Assignment (3rd-Place per Slot)', id: 'R32 Slot Assignment (Peringkat-3 per Slot)' },
      thirdSlotsNote: { en: 'Each R32 slot for a 3rd-placed team only draws from a fixed set of groups (see each table\'s label). Since a group can appear in more than one slot, a single 3rd-placed team can only represent one slot — if it\'s already taken by an earlier slot, the next slot automatically falls to the next-best available team.', id: 'Tiap slot babak 32 besar untuk peringkat-3 hanya mengambil dari grup tertentu (lihat label tiap tabel). Karena satu grup bisa muncul di lebih dari satu slot, satu tim peringkat-3 hanya bisa jadi wakil di salah satu slot — kalau sudah terpakai di slot lain, slot berikutnya otomatis jatuh ke peringkat berikutnya yang masih tersedia.' },
      thirdSlotLabel: { en: '3rd Place — Group {groups}', id: 'Peringkat-3 Grup {groups}' },
      r32Rep: { en: 'R32 Representative', id: 'Wakil R32' },
      r32UsedElsewhere: { en: 'Already used in another slot', id: 'Sudah wakil slot lain' },
      disclaimer: {
