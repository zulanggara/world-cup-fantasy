...
window.I18N = (function () {
  ...
  const DICT = {
    ...
    index: {
      ...
      projCtaTitle: { en: 'Next Round Projection: who to pick for Quarter Finals', id: 'Proyeksi Ronde Depan: pilihan pemain untuk Perempat Final', ar: 'توقع الجولة القادمة: من تختار لربع النهائي', ms: 'Unjuran Pusingan Seterusnya: pilihan pemain untuk Suku Akhir' },
      projCtaSub: { en: 'Best 15 squad forecast with budget, qualifier status, and rotation risk — max 5 players per nation.', id: 'Proyeksi Best 15 lengkap dengan budget, status lolos, dan risiko rotasi — maks 5 pemain per negara.', ar: 'توقع أفضل 15 لاعباً مع الميزانية وحالة التأهل وخطر التدوير — حد أقصى 5 لاعبين لكل دولة.', ms: 'Unjuran 15 Terbaik lengkap dengan bajet, status layak, dan risiko putaran — maks 5 pemain setiap negara.' },
