...
window.I18N = (function () {
  ...
  const DICT = {
    ...
    index: {
      ...
      lbKeyPasses: { en: 'Most Key Passes', id: 'Umpan Kunci Terbanyak', ar: 'أكثر التمريرات المفتاحية', ms: 'Hantaran Kunci Terbanyak' },
      ...
      unitKeyPasses: { en: 'key passes', id: 'umpan kunci', ar: 'تمريرات مفتاحية', ms: 'hantaran kunci' },
    ...
    donate: {
      ...
      note: { en: '<b>Where does this go?</b> Hosting costs (Vercel), and the time spent keeping data &amp; features updated throughout the tournament. Donating is never required — this site stays free and open for everyone.', id: '<b>Ke mana dukungan ini dipakai?</b> Biaya hosting (Vercel), dan waktu untuk terus update data &amp; fitur selama turnamen berlangsung. Tidak ada keharusan untuk donasi — situs ini tetap gratis dan terbuka untuk semua orang.', ar: '<b>أين تذهب هذه المساهمة؟</b> تكاليف الاستضافة (Vercel)، والوقت المستغرق في تحديث البيانات والميزات طوال البطولة. التبرع غير مطلوب أبداً — يبقى هذا الموقع مجانياً ومفتوحاً لجميع الناس.', ms: '<b>Ke mana sokongan ini digunakan?</b> Kos hosting (Vercel), dan masa untuk terus mengemas kini data &amp; ciri sepanjang kejohanan. Derma tidak diwajibkan — laman ini kekal percuma dan terbuka untuk semua orang.' },
